...
app.get('/', (req, res) => res.render('pages/index', { user: userManager.users.get(req.cookies[SESS_ID_COOKIE]) }));
...
app.get(
  ...
  (req, res) => {
    fs.readFile(
      ...
      (err, changelog) => res.render('pages/changelog', { user: userManager.users.get(req.cookies[SESS_ID_COOKIE]), changelog }),
    );
  },
);
